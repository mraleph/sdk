...
class Function : public Object {
 public:
  ...
  std::pair<uint8_t, uint8_t> awaiter_link() const;
  void set_awaiter_link(std::pair<uint8_t, uint8_t> link) const;
  bool HasAwaiterLink() const {
    return IsClosureFunction() &&
           (awaiter_link().first != UntaggedClosureData::kNoAwaiterLinkDepth);
  }
