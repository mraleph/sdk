...
#define CACHED_VM_STUBS_LIST(V)                                                \
  ...
  V(RawCode*, subtype1test_stub_code_,                                         \
    StubCode::Subtype1TestCache_entry()->code(), NULL)                         \
  V(RawCode*, subtype2test_stub_code_,                                         \
    StubCode::Subtype2TestCache_entry()->code(), NULL)                         \
  V(RawCode*, subtype4test_stub_code_,                                         \
    StubCode::Subtype4TestCache_entry()->code(), NULL)                         \
...
#define CACHED_VM_STUBS_ADDRESSES_LIST(V)                                      \
  ...
  V(uword, subtype1test_stub_entry_,                                           \
    StubCode::Subtype1TestCache_entry()->EntryPoint(), 0)                      \
  V(uword, subtype2test_stub_entry_,                                           \
    StubCode::Subtype2TestCache_entry()->EntryPoint(), 0)                      \
  V(uword, subtype4test_stub_entry_,                                           \
    StubCode::Subtype4TestCache_entry()->EntryPoint(), 0)
