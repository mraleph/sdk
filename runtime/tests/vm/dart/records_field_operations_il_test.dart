...
void matchIL$testDouble(FlowGraph graph) {
  graph.match([
    ...
    match.block('Function', [
      ...
      match.StaticCall('v5_boxed'),
      'obj_cid' << match.LoadClassId('obj'),
      'rec6' << match.DispatchTableCall('obj', 'obj_cid'),
      ...
      match.StaticCall('v6_boxed'),
      'v7' << match.BinaryDoubleOp('a', 'b'),
      'v7_boxed' << match.Box('v7'),
      match.StaticCall('v7_boxed'),
      match.Return(),
    ]),
  ]);
}
